...
export function DeleteLectureDialog({ open, isDeleting, onCancel, onConfirm }: DeleteLectureDialogProps) {
  return (
    <Dialog open={open} onClose={onCancel} title="Delete lecture?">
      <div className="flex flex-col gap-4">
        <div className="flex items-start gap-3 rounded-lg border border-[#C0392B]/20 bg-[#C0392B]/5 px-3.5 py-3">
          ...
          <p className="text-sm text-forest-dark">
            Are you sure you want to delete this lecture? This action can't be undone.
          </p>
        </div>
